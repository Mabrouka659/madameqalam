...
import BenefitRepository from "../repository/benefit_repository.js";

class BenefitController {
	public index = async (req: Request, res: Response) => {
		// récuperer tous les enregistrements
		const results = await new BenefitRepository().selectAll();
		console.log(results);
	...
	public one = async (req: Request, res: Response) => {
		// récuperer tous les enregistrements
		const results = await new BenefitRepository().selectOne(req.params);
		console.log(results);
