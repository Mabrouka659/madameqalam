...
import ImagesRepository from "../repository/images_repository.js";

class ImagesController {
	public index = async (req: Request, res: Response) => {
		// récuperer tous les enregistrements
		const results = await new ImagesRepository().selectAll();
		console.log(results);
	...
	public one = async (req: Request, res: Response) => {
		// récuperer tous les enregistrements
		const results = await new ImagesRepository().selectOne(req.params);
		console.log(results);
